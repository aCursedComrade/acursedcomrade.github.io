...
t.href=decodeURIComponent(atob(e.dataset.url).split("").map((e=>"%"+("00"+e.charCodeAt(0).toString(16)).slice(-2))).join("")),t.rel="noopener external nofollow noreferrer",t.target="_blank",t.className=e.className,t.title=e.title,t.innerHTML=e.innerHTML,e.parentNode.replaceChild(t,e)}))},registerCodeblock:function(){let e=document.querySelectorAll("figure.highlight"),t=!0;0===e.length&&(e=document.querySelectorAll("pre:not(.mermaid)"),t=!1),e.forEach((e=>{let n=e.querySelectorAll(".code .line span");0===n.length&&(
// Hljs without line_number and wrap
n=e.querySelectorAll("code.highlight span")),n.forEach((e=>{e.classList.forEach((t=>{e.classList.replace(t,`hljs-${t}`)}))}));const o=parseInt(window.getComputedStyle(e).height.replace("px",""),10),i=CONFIG.fold.enable&&o>CONFIG.fold.height;if(!i&&!CONFIG.copycode.enable)return;let c;if(t&&"mac"===CONFIG.copycode.style)c=e;else{
// https://github.com/next-theme/hexo-theme-next/issues/98
// https://github.com/next-theme/hexo-theme-next/pull/508
const t=e.querySelector(".table-container")||e,n=document.createElement("div");n.className="code-container",t.wrap(n),c=n}if(i&&(c.classList.add("highlight-fold"),c.insertAdjacentHTML("beforeend",'<div class="fold-cover"></div><div class="expand-btn"><i class="fa fa-angle-down fa-fw"></i></div>'),c.querySelector(".expand-btn").addEventListener("click",(()=>{c.classList.remove("highlight-fold")}))),!CONFIG.copycode.enable)return;
