...
{% img https://stash.comradelab.win/img/flask_start.png "Flask app configured and listening" %}
...
{% img https://stash.comradelab.win/img/flask_etc_passwd.png "The content of /etc/passwd as the response" %}
...
{% img https://stash.comradelab.win/img/proc_contents.png "Contents of /proc" %}
...
{% img https://stash.comradelab.win/img/proc_cpuinfo.png "Response of /proc/cpuinfo (truncated)" %}

- `/proc/meminfo`
  - Returns information about the system memory. This includes total memory, used memory, free memory, etc.

{% img https://stash.comradelab.win/img/proc_meminfo.png "Response of /proc/meminfo (truncated)" %}

- `/proc/version`
  - Returns the kernel version information.

{% img https://stash.comradelab.win/img/proc_version.png "Response of /proc/version" %}

- `/proc/partitions`
  - Returns the partition table known to the system.

{% img https://stash.comradelab.win/img/proc_partitions.png "Response of /proc/partitions" %}
...
{% img https://stash.comradelab.win/img/proc_mounts.png "Response of /proc/mounts" %}

{% img https://stash.comradelab.win/img/secret_message.png "Secrets exposed!!!" %}
...
{% img https://stash.comradelab.win/img/proc_net_arp.png "Response of /proc/net/arp" %}
...
{% img https://stash.comradelab.win/img/proc_task.png "Threads in my 'Terminator' session" %}
...
{% img https://stash.comradelab.win/img/proc_cmd.png "Response of /proc/self/cmd & /proc/self/cmdline" %}
...
{% img https://stash.comradelab.win/img/proc_status.png "Response of /proc/self/status" %}
...
{% img https://stash.comradelab.win/img/proc_environ.png "Response of /proc/self/environ" %}
...
{% img https://stash.comradelab.win/img/proc_cwd.png "Content of /proc/self/cwd/" %}

{% img https://stash.comradelab.win/img/proc_cwd_var.png "PWD variable as seen in /proc/self/environ" %}
...
{% img https://stash.comradelab.win/img/proc_exe.png "Content of /proc/self/exe" %}
...
{% img https://stash.comradelab.win/img/proc_fd.png "Content of /proc/self/fd/" %}
...
{% img https://media.tenor.com/KmPFMGQ07-4AAAAd/hffgf.gif "Cat hacking the system" %}
